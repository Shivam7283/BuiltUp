import 'package:builtup/Semester/sem3/subjects/Engineering_Thermodynamics/papers/sem3ETpaper.dart';
import 'package:builtup/Semester/sem3/subjects/Engineering_Thermodynamics/papers/sem3ETquepaper.dart';
import 'package:builtup/Semester/sem3/subjects/Engineering_Thermodynamics/syllabus/syllabussem3ET.dart';
...
class Sem3EToption extends StatelessWidget {
  @override
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => syllabussem3ET(),
                  ),
                );
              },
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => sem3ETquepapers(),
                  ),
                );
              },
              shape: RoundedRectangleBorder(
